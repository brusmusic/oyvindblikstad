...
export function createAdaptiveBreathCurves(entryProfile, options = {}) {
  ...
  const startInhale = detected ? clamp(entryProfile.breath.inhaleDuration, 1.5, 9) : fallback.inhale;
  const startExhale = detected ? clamp(entryProfile.breath.exhaleDuration, 2, 14) : fallback.exhale;
